...
import { ProcessCreatifContent } from './ProcessCreatifContent';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <nav>
                <ol className="flex items-center space-x-2 text-sm text-white/90">
                  <li>
                    <Link to="/ressources" className="hover:text-white">
                      Ressources
                    </Link>
                  </li>
                  <li>
            ...
            <div className="max-w-[1400px] mx-auto">
              <nav className="mb-6">
                <ol className="flex items-center space-x-2 text-sm text-gray-500">
                  <li>
                    <Link to="/ressources" className="hover:text-primary-600">
                      Ressources
                    </Link>
                  </li>
                  <li>
